...
Memory Performance Issue?
 Low global memory efficiency?
    Fix coalescing → [Global Memory Guide](2_global_memory.md)
    Use shared memory tiling → [Shared Memory Guide](3_shared_memory.md)
 Shared memory bank conflicts?
    Add padding, fix access patterns → [Shared Memory Guide](3_shared_memory.md#bank-conflicts)
 Small uniform read-only data?
    Use constant memory → [Constant Memory Guide](4_constant_memory.md)
 Complex CPU-GPU workflows?
    Optimize unified memory → [Unified Memory Guide](5_unified_memory.md)
 Still having issues?
     Systematic debugging → [Debugging Toolkit](6_memory_debugging.md)
```
...
3. **Specialize with**: [Constant Memory Guide](4_constant_memory.md) or [Unified Memory Guide](5_unified_memory.md)
