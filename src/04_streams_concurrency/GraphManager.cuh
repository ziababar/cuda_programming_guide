...
inline __global__ void graph_stage1_kernel(float* input, float* output, int N);
inline __global__ void graph_stage2_kernel(float* input, float* output, int N);
...
inline void demonstrate_basic_graph_operations() {
